      ...
      >
        ...
        >
          <Button
            ...
            size="lg"
            className="w-full font-bold text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 shadow-lg shadow-purple-600/20 transition-all duration-300 hover:shadow-purple-600/40 hover:scale-[1.02]"
            startContent={
