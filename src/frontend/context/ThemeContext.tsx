...
export const NITRO_THEMES: NitroTheme[] = [
  ...
  {
    id: "amoled-pitch",
    name: "AMOLED Black Pink",
    category: "dark",
    description: "Pure AMOLED black with vivid hot pink accents, glows and hovers",
    previewColors: ["#FF007F", "#FF4DA6", "#000000"],
    bgPrimary: "#000000",
    bgSecondary: "#0a0008",
    bgRadial: "radial-gradient(at 50% 0%, rgba(255, 0, 127, 0.12) 0px, transparent 60%), radial-gradient(at 100% 100%, rgba(255, 0, 127, 0.06) 0px, transparent 50%)",
    accent: "#FF007F",
    accentGlow: "rgba(255, 0, 127, 0.4)",
    cardBg: "rgba(255, 0, 127, 0.04)",
    cardBorder: "rgba(255, 0, 127, 0.18)",
    glassPanelBg: "rgba(5, 0, 3, 0.85)",
    textPrimary: "#FFFFFF",
